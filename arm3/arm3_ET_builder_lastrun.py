...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/goldlab/Documents/Ishan_summer23/test_runs/arm3/arm3_ET_builder_lastrun.py',
...
for thisStep in steps:
    ...
    while continueRoutine:
        ...
        if second_stock.status == NOT_STARTED and cont == False and tThisFlip >= 2-frameTolerance:
            # keep track of start time/frame for later
