...
var explainFrequencyComponents;
var explainFrequencyClock;
var explainFrequency_top_text;
var explainFrequency_center_box;


var explainLowFrequencyComponents;
var explainLowFrequencyClock;
var explainLowFrequency_top_text;
var explainLowFrequency_center_box;
...
var explainHighFrequencyComponents;
var explainHighFrequencyClock;
var explainHighFrequency_top_text;
var explainHighFrequency_center_box;
...
var score_height;
var conditions;
const condText = 'Feedback Frequency';
var resp;
var reward_pres;
var blockDisplay;
var blockN = 0;
...
flowScheduler.add(explainFrequencyRoutineBegin());
flowScheduler.add(explainFrequencyRoutineEachFrame());
flowScheduler.add(explainFrequencyRoutineEnd());
flowScheduler.add(explainHighFrequencyRoutineBegin());
flowScheduler.add(explainHighFrequencyRoutineEachFrame());
flowScheduler.add(explainHighFrequencyRoutineEnd());
flowScheduler.add(startTrainingRoutineBegin());
flowScheduler.add(startTrainingRoutineEachFrame());
flowScheduler.add(startTrainingRoutineEnd());
...
flowScheduler.add(explainLowFrequencyRoutineBegin());
flowScheduler.add(explainLowFrequencyRoutineEachFrame());
flowScheduler.add(explainLowFrequencyRoutineEnd());
flowScheduler.add(startTrainingRoutineBegin());
flowScheduler.add(startTrainingRoutineEachFrame());
flowScheduler.add(startTrainingRoutineEnd());
...
async function experimentInit() {
  ...
  explainFrequencyClock = new util.Clock();
  explainHighFrequencyClock = new util.Clock();
  fifthPracticeClock = new util.Clock();
  explainLowFrequencyClock = new util.Clock();
  ...
  explainButtons_top_text = new visual.TextStim({
   ...
   explainStability_top_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'vars_text',
    text: "Throughout the experiment, you will be in a somewhat stable environment. That is, if you answer correctly that a trial is UP, there is about a 65% chance that the next trial will also be UP (and this applies to DOWN as well). Keeping this in mind may allow you to perform better and increase your salary bonus.",
    font: 'Open Sans',
    pos: [0, 0.4], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
  ...
  explainFrequency_top_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'vars_text',
    text: "Finally, the “Feedback Frequency” of a block determines how often you are given feedback in the form of “Correct!” and Error!” We will be manipulating the feedback frequency for each of the 8 blocks. The levels range from low to high and will be shown on the slider below.",
    font: 'Open Sans',
    pos: [0, 0.4], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
  ...
  explainFrequency_center_box = new visual.Rect ({
    win: psychoJS.window, name: 'side_box2', 
  ...
  explainHighFrequency_top_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'vars_text',
    text: "If you are in a HIGH frequency block, you should expect to see “Correct!” for accurate choices and “Error!” for inaccurate choices, and you should not expect to see “No Feedback Given!” often. Noting this can allow you to perform better and increase your salary bonus.",
    font: 'Open Sans',
    pos: [0, 0.4], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
  ...
  explainHighFrequency_center_box = new visual.Rect ({
    win: psychoJS.window, name: 'side_box2', 
    width: 0.23, height: 0.05,
    ori: 0.0, pos: [-0.21, 0.2625],
    lineWidth: 5.0, 
  ...
  explainLowFrequency_top_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'vars_text',
    text: "If you are in a LOW frequency block, you should expect to see “No Feedback Given!” often, which means you may have fewer opportunities to receive feedback and increase your salary bonus. Noting this can allow you to formulate a strategy that lets you maximize your salary bonus when you do receive feedback.",
    font: 'Open Sans',
    pos: [0, 0.4], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
  ...
  explainLowFrequency_center_box = new visual.Rect ({
    win: psychoJS.window, name: 'side_box2', 
    width: 0.23, height: 0.05,
    ori: 0.0, pos: [-0.21, 0.2625],
    lineWidth: 5.0, 
  ...
  reward_pres = new visual.TextStim({
    ...
    display_q_level = new visual.ShapeStim ({
    win: psychoJS.window, name: 'q_level', 
  ...
  display_q_dot = new visual.Polygon({
    win: psychoJS.window, name: 'q_dot',
    colorSpace: 'rgb',
    pos: [,-0.1],
    radius: 0.005,
...
function firstPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // firstPracticeComponents.push(q_level);
    // firstPracticeComponents.push(q_dot);
...
function secondPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // secondPracticeComponents.push(q_level);
    // secondPracticeComponents.push(q_dot);
...
function thirdPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // thirdPracticeComponents.push(q_level);
    // thirdPracticeComponents.push(q_dot);
...
function explainScoreRoutineBegin(snapshot) {
  return async function () {
    ...
    // explainScoreComponents.push(q_level);
    // explainScoreComponents.push(q_dot);
...
function explainScoreRoutineEachFrame() {
  return async function () {
    ...
    // if (t >= 0.0 && q_level.status === PsychoJS.Status.NOT_STARTED) {
    //   // keep track of start time/frame for later
    //   q_level.tStart = t;  // (not accounting for frame time here)
    //   q_level.frameNStart = frameN;  // exact frame index
    //   q_level.setAutoDraw(true);
    ...
    // if (t >= 0.0 && q_dot.status === PsychoJS.Status.NOT_STARTED) {
    //   // keep track of start time/frame for later
    //   q_dot.tStart = t;  // (not accounting for frame time here)
    //   q_dot.frameNStart = frameN;  // exact frame index
    //   q_dot.setAutoDraw(true);
...
function explainBenchmarkRoutineBegin(snapshot) {
  return async function () {
    ...
    // explainBenchmarkComponents.push(q_level);
    // explainBenchmarkComponents.push(q_dot);
...
function fourthPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // fourthPracticeComponents.push(q_level);
    // fourthPracticeComponents.push(q_dot);
...
// explainFrequency text
function explainFrequencyRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    counterNum = numSteps;
    score = 0;
    ...
    //--- Prepare to start Routine 'instructions' ---
    t = 0;
    explainFrequencyClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    space_bar.keys = undefined;
    ...
    _space_bar_allKeys = [];
    // keep track of which components have finished
    explainFrequencyComponents = [];
    explainFrequencyComponents.push(space_to_continue);
    explainFrequencyComponents.push(explainFrequency_top_text);
    explainFrequencyComponents.push(explainFrequency_center_box);
    explainFrequencyComponents.push(plotLim);
    explainFrequencyComponents.push(zeroLine);
    explainFrequencyComponents.push(dummystock);
    explainFrequencyComponents.push(counter);
    explainFrequencyComponents.push(running_score);
    explainFrequencyComponents.push(counter_img);
    explainFrequencyComponents.push(running_score_img);
    explainFrequencyComponents.push(thresh);
    explainFrequencyComponents.push(thresh_text);
    explainFrequencyComponents.push(counter_bar);
    explainFrequencyComponents.push(score_bar);
    explainFrequencyComponents.push(conditions);
    explainFrequencyComponents.push(low);
    explainFrequencyComponents.push(high);
    explainFrequencyComponents.push(q_level);
    explainFrequencyComponents.push(q_dot);
    explainFrequencyComponents.push(space_bar);
    
    for (const thisComponent of explainFrequencyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function explainFrequencyRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'instructions' ---
    // get current time
    t = explainFrequencyClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    if (t >= 0.0 && explainFrequency_top_text.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainFrequency_top_text.tStart = t;  // (not accounting for frame time here)
      explainFrequency_top_text.frameNStart = frameN;  // exact frame index
      explainFrequency_top_text.setAutoDraw(true);
    }
    
    if (t >= 0.0 && explainFrequency_center_box.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainFrequency_center_box.tStart = t;  // (not accounting for frame time here)
      explainFrequency_center_box.frameNStart = frameN;  // exact frame index
      explainFrequency_center_box.setAutoDraw(true);
    }
...
function explainFrequencyRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'instructions' ---
    for (const thisComponent of explainFrequencyComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
...
// explainHighFrequency text
function explainHighFrequencyRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    counterNum = numSteps;
    score = 0;
    ...
    //--- Prepare to start Routine 'instructions' ---
    t = 0;
    explainHighFrequencyClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    space_bar.keys = undefined;
    ...
    _space_bar_allKeys = [];
    // keep track of which components have finished
    explainHighFrequencyComponents = [];
    explainHighFrequencyComponents.push(space_to_continue);
    explainHighFrequencyComponents.push(explainHighFrequency_top_text);
    explainHighFrequencyComponents.push(explainHighFrequency_center_box);
    explainHighFrequencyComponents.push(plotLim);
    explainHighFrequencyComponents.push(zeroLine);
    explainHighFrequencyComponents.push(dummystock);
    explainHighFrequencyComponents.push(counter);
    explainHighFrequencyComponents.push(running_score);
    explainHighFrequencyComponents.push(counter_img);
    explainHighFrequencyComponents.push(running_score_img);
    explainHighFrequencyComponents.push(thresh);
    explainHighFrequencyComponents.push(thresh_text);
    explainHighFrequencyComponents.push(counter_bar);
    explainHighFrequencyComponents.push(score_bar);
    explainHighFrequencyComponents.push(conditions);
    explainHighFrequencyComponents.push(low);
    explainHighFrequencyComponents.push(high);
    explainHighFrequencyComponents.push(q_level);
    explainHighFrequencyComponents.push(q_dot);
    explainHighFrequencyComponents.push(space_bar);
    
    for (const thisComponent of explainHighFrequencyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function explainHighFrequencyRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'instructions' ---
    // get current time
    t = explainHighFrequencyClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    if (t >= 0.0 && explainHighFrequency_top_text.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainHighFrequency_top_text.tStart = t;  // (not accounting for frame time here)
      explainHighFrequency_top_text.frameNStart = frameN;  // exact frame index
      explainHighFrequency_top_text.setAutoDraw(true);
    }
    
    if (t >= 0.0 && explainHighFrequency_center_box.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainHighFrequency_center_box.tStart = t;  // (not accounting for frame time here)
      explainHighFrequency_center_box.frameNStart = frameN;  // exact frame index
      explainHighFrequency_center_box.setAutoDraw(true);
    }
...
function explainHighFrequencyRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'instructions' ---
    for (const thisComponent of explainHighFrequencyComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
...
function fifthPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    fifthPracticeComponents.push(q_level);
    fifthPracticeComponents.push(q_dot);
...
// explainLowFrequency text
function explainLowFrequencyRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    counterNum = numSteps;
    score = 0;
    ...
    //--- Prepare to start Routine 'instructions' ---
    t = 0;
    explainLowFrequencyClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    space_bar.keys = undefined;
    ...
    _space_bar_allKeys = [];
    // keep track of which components have finished
    explainLowFrequencyComponents = [];
    explainLowFrequencyComponents.push(space_to_continue);
    explainLowFrequencyComponents.push(explainLowFrequency_top_text);
    explainLowFrequencyComponents.push(explainLowFrequency_center_box);
    explainLowFrequencyComponents.push(plotLim);
    explainLowFrequencyComponents.push(zeroLine);
    explainLowFrequencyComponents.push(dummystock);
    explainLowFrequencyComponents.push(counter);
    explainLowFrequencyComponents.push(running_score);
    explainLowFrequencyComponents.push(counter_img);
    explainLowFrequencyComponents.push(running_score_img);
    explainLowFrequencyComponents.push(thresh);
    explainLowFrequencyComponents.push(thresh_text);
    explainLowFrequencyComponents.push(counter_bar);
    explainLowFrequencyComponents.push(score_bar);
    explainLowFrequencyComponents.push(conditions);
    explainLowFrequencyComponents.push(low);
    explainLowFrequencyComponents.push(high);
    explainLowFrequencyComponents.push(q_level);
    explainLowFrequencyComponents.push(q_dot);
    explainLowFrequencyComponents.push(space_bar);
    
    for (const thisComponent of explainLowFrequencyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function explainLowFrequencyRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'instructions' ---
    // get current time
    t = explainLowFrequencyClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    ...
    if (t >= 0.0 && explainLowFrequency_top_text.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainLowFrequency_top_text.tStart = t;  // (not accounting for frame time here)
      explainLowFrequency_top_text.frameNStart = frameN;  // exact frame index
      explainLowFrequency_top_text.setAutoDraw(true);
    }
    
    if (t >= 0.0 && explainLowFrequency_center_box.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      explainLowFrequency_center_box.tStart = t;  // (not accounting for frame time here)
      explainLowFrequency_center_box.frameNStart = frameN;  // exact frame index
      explainLowFrequency_center_box.setAutoDraw(true);
    }
...
function explainLowFrequencyRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'instructions' ---
    for (const thisComponent of explainLowFrequencyComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
...
function sixthPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    sixthPracticeComponents.push(q_level);
    sixthPracticeComponents.push(q_dot);
...
function displayRoutineBegin(snapshot) {
  return async function () {
   ...
   displayClock.reset(); // clock
    ...
    displayComponents.push(display_q_level);
    displayComponents.push(display_q_dot);
...
function displayRoutineEachFrame() {
  return async function () {
    ...
    // *text* updates
    if (t >= 0.0 && display_q_level.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      display_q_level.tStart = t;  // (not accounting for frame time here)
      display_q_level.frameNStart = frameN;  // exact frame index
      display_q_level.setAutoDraw(true);
    }

    // *text* updates
    if (t >= 0.0 && display_q_dot.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      display_q_dot.tStart = t;  // (not accounting for frame time here)
      display_q_dot.frameNStart = frameN;  // exact frame index
      display_q_dot.setAutoDraw(true);
    }
...
function presentationRoutineBegin(snapshot) {
  return async function () {
    ...
    presentationComponents.push(q_level);
    presentationComponents.push(q_dot);
